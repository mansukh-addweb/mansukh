...
(function() {
var config = {};
if (typeof(window.msuodc_enabled) !== 'undefined'
    && window.msuodc_enabled
   ) {
    if (typeof(window.msuodc_widget_settings) === 'undefined') {
        config = {
            config: {
                mixins: {
                    'Magento_Checkout/js/action/set-shipping-information': {
                        'Mediastrategi_UODC/js/action/set-shipping-information-mixin': true
                    },
                    'Magento_Checkout/js/view/cart/shipping-rates': {
                        'Mediastrategi_UODC/js/view/cart/shipping-rates': true
                    },
                    'Magento_Checkout/js/view/shipping': {
                        'Mediastrategi_UODC/js/view/shipping': true
                    },
                    'Klarna_Kco/js/view/shipping-method': {
                        'Mediastrategi_UODC/js/view/klarna-kco/shipping-method': true
                    }
                }
            }
        };
