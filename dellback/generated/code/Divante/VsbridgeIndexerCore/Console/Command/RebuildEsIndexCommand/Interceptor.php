<?php
namespace Divante\VsbridgeIndexerCore\Console\Command\RebuildEsIndexCommand;

/**
 * Interceptor class for @see \Divante\VsbridgeIndexerCore\Console\Command\RebuildEsIndexCommand
 */
class Interceptor extends \Divante\VsbridgeIndexerCore\Console\Command\RebuildEsIndexCommand implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Divante\VsbridgeIndexerCore\Console\Command\Rebuild\RebuildFactory $rebuildIndicesFactory, \Magento\Framework\Event\ManagerInterface $manager, \Magento\Framework\App\State $appState)
    {
        $this->___init();
        parent::__construct($rebuildIndicesFactory, $manager, $appState);
    }
