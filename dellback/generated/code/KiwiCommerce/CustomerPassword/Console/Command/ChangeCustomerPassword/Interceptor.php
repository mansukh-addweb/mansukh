<?php
namespace KiwiCommerce\CustomerPassword\Console\Command\ChangeCustomerPassword;

/**
 * Interceptor class for @see \KiwiCommerce\CustomerPassword\Console\Command\ChangeCustomerPassword
 */
class Interceptor extends \KiwiCommerce\CustomerPassword\Console\Command\ChangeCustomerPassword implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\KiwiCommerce\CustomerPassword\Model\PasswordManagement $accountManagement, \Magento\Framework\App\State $state, \KiwiCommerce\CustomerPassword\Helper\Data $helper)
    {
        $this->___init();
        parent::__construct($accountManagement, $state, $helper);
    }
