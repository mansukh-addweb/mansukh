<?php
namespace Xtento\ProductExport\Console\Command\ConfigImportCommand;

/**
 * Interceptor class for @see \Xtento\ProductExport\Console\Command\ConfigImportCommand
 */
class Interceptor extends \Xtento\ProductExport\Console\Command\ConfigImportCommand implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\App\State $appState, \Xtento\ProductExport\Helper\Tools $toolsHelper)
    {
        $this->___init();
