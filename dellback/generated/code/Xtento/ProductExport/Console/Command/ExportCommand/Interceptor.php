<?php
namespace Xtento\ProductExport\Console\Command\ExportCommand;

/**
 * Interceptor class for @see \Xtento\ProductExport\Console\Command\ExportCommand
 */
class Interceptor extends \Xtento\ProductExport\Console\Command\ExportCommand implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\App\State $appState, \Magento\Framework\App\AreaList $areaList, \Magento\Framework\ObjectManagerInterface $objectManager, \Xtento\ProductExport\Model\ProfileFactory $profileFactory, \Xtento\ProductExport\Model\ExportFactory $exportFactory)
    {
        $this->___init();
        parent::__construct($appState, $areaList, $objectManager, $profileFactory, $exportFactory);
    }
