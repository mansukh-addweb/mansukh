...
class Interceptor extends \Magento\Backend\Block\Menu implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getMenuModel()
    {
        ...
        if (!$pluginInfo) {
            return parent::getMenuModel();
        } else {
            return $this->___callPlugins('getMenuModel', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function renderMenu($menu, $level = 0)
    {
        ...
        if (!$pluginInfo) {
            return parent::renderMenu($menu, $level);
        } else {
            return $this->___callPlugins('renderMenu', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getActiveItemModel()
    {
        ...
        if (!$pluginInfo) {
            return parent::getActiveItemModel();
        } else {
            return $this->___callPlugins('getActiveItemModel', func_get_args(), $pluginInfo);
        }
    }
