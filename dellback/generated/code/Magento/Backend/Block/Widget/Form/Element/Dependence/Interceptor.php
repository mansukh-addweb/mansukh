...
class Interceptor extends \Magento\Backend\Block\Widget\Form\Element\Dependence implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function addFieldMap($fieldId, $fieldName)
    {
        ...
        if (!$pluginInfo) {
            return parent::addFieldMap($fieldId, $fieldName);
        } else {
            return $this->___callPlugins('addFieldMap', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function addConfigOptions(array $options)
    {
        ...
        if (!$pluginInfo) {
            return parent::addConfigOptions($options);
        } else {
            return $this->___callPlugins('addConfigOptions', func_get_args(), $pluginInfo);
        }
    }
