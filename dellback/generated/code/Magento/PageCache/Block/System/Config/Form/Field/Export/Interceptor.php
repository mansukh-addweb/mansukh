...
class Interceptor extends \Magento\PageCache\Block\System\Config\Form\Field\Export implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getVarnishVersion()
    {
        ...
        if (!$pluginInfo) {
            return parent::getVarnishVersion();
        } else {
            return $this->___callPlugins('getVarnishVersion', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getTtlValue()
    {
        ...
        if (!$pluginInfo) {
            return parent::getTtlValue();
        } else {
            return $this->___callPlugins('getTtlValue', func_get_args(), $pluginInfo);
        }
    }
