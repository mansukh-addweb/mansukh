<?php
namespace Vendic\VueStorefrontSitemap\Console\RunGenerateSitemap;

/**
 * Interceptor class for @see \Vendic\VueStorefrontSitemap\Console\RunGenerateSitemap
 */
class Interceptor extends \Vendic\VueStorefrontSitemap\Console\RunGenerateSitemap implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Vendic\VueStorefrontSitemap\Cron\GenerateSitemap $generateSitemapCron)
    {
        $this->___init();
        parent::__construct($generateSitemapCron);
    }
