...
class RuleProductsSelectBuilder
{
    ...
    public function build(
        ...
        $this->joinMageworxDecimalPrice($select, $linkField, $priceAttributeId);
        $this->joinMageworxDecimalSpecialPrice($select, $linkField, $specialPriceAttributeId);
     ...
     * @return mixed
     */
    protected function joinMageworxDecimalPrice($select, $linkField, $priceAttributeId)
    {
        return $select->join(
            [
            ...
            'mageworx_decimal_price.' . $linkField . ' = e.' . $linkField . ' 
     ...
     * @return mixed
     */
    protected function joinMageworxDecimalSpecialPrice($select, $linkField, $specialPriceAttributeId)
    {
        ...
        return $select->join(
            ...
            'mageworx_decimal_special_price.' . $linkField . ' = e.' . $linkField . ' 
