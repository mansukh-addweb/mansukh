...
class UpgradeSchema implements UpgradeSchemaInterface
{
    ...
    public function upgrade(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        if (version_compare($context->getVersion(), '1.0.4', '<')) {
            $this->addUniqueKeyToMageWorxCustomerPricesTable($setup);
            $this->addForeignKeyToMageWorxCustomerPricesTable($setup);
        }
        ...
        $table     = $setup->getConnection()
                           ...
                           ->addIndex(
                               $setup->getIdxName(
                                   ...
                                   [$linkField, 'attribute_id', 'store_id', 'customer_id'],
     ...
     * @throws \Exception
     */
    protected function addForeignKeyToMageWorxCustomerPricesTable(SchemaSetupInterface $setup)
    {
        $linkField = $this->helperCalculate->getLinkField();

        $table = $setup->getTable('mageworx_customerprices');
        $setup->getConnection()->addForeignKey(
            $setup->getFkName($table, 'product_id', 'catalog_product_entity', $linkField),
            $setup->getTable('mageworx_customerprices'),
            'product_id',
            $setup->getTable('catalog_product_entity'),
            $linkField,
     ...
     * @param SchemaSetupInterface $setup
     */
    protected function addUniqueKeyToMageWorxCustomerPricesTable(SchemaSetupInterface $setup)
    {
