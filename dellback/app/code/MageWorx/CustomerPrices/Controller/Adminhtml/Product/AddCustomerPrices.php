...
class AddCustomerPrices extends \Magento\Catalog\Controller\Adminhtml\Product
{
    ...
    public function execute()
    {
        ...
        // entity type
        $attributeType = \MageWorx\CustomerPrices\Model\CustomerPrices::TYPE_PRICE_CUSTOMER;
        ...
        if (empty($productId) || empty($customerId) || (empty($price) && empty($specialPrice))) {
            ...
            $productId = $this->helperProduct->getLinkFieldIdByProductId($productId);
            ...
            try {
                $this->deleteData($productId, $customerId);
    ...
    {
        $this->customerPricesResourceModel->deleteProductCustomerPrice($productId, $customerId);
        ...
        $this->customerPricesResourceModel->deleteRowInMageworxCatalogProductIndexPrice(
            $this->helperProduct->getProductEntityId($productId),
            $customerId
        );
    }
}